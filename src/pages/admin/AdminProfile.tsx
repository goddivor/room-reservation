...
const AdminProfile: React.FC = () => {
  ...
  const [adminData, setAdminData] = useState<AdminProfileData>({
    ...
    bio: "System administrator responsible for room management and user coordination.",
    preferences: {
  ...
  const avatarOptions: AvatarOption[] = [
    {
      id: "1",
      name: "Default",
      url: `https://api.dicebear.com/7.x/avataaars/svg?seed=${adminData.firstName}${adminData.lastName}`,
    },
    {
      id: "2",
      name: "Alternative 1",
      url: `https://api.dicebear.com/7.x/avataaars/svg?seed=admin1&backgroundColor=b6e3f4`,
    },
    {
      id: "3",
      name: "Alternative 2",
      url: `https://api.dicebear.com/7.x/avataaars/svg?seed=admin2&backgroundColor=c0aede`,
    },
    {
      id: "4",
      name: "Alternative 3",
      url: `https://api.dicebear.com/7.x/avataaars/svg?seed=admin3&backgroundColor=d1d4f9`,
    },
    {
      id: "5",
      name: "Alternative 4",
      url: `https://api.dicebear.com/7.x/avataaars/svg?seed=admin4&backgroundColor=fecaca`,
    },
    {
      id: "6",
      name: "Alternative 5",
      url: `https://api.dicebear.com/7.x/avataaars/svg?seed=admin5&backgroundColor=fed7aa`,
    },
    {
      id: "7",
      name: "Alternative 6",
      url: `https://api.dicebear.com/7.x/avataaars/svg?seed=admin6&backgroundColor=d9f99d`,
    },
    {
      id: "8",
      name: "Alternative 7",
      url: `https://api.dicebear.com/7.x/avataaars/svg?seed=admin7&backgroundColor=fbcfe8`,
    },
  ];
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (selectedAvatar !== adminData.avatar) {
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  value={adminData.bio || ""}
                  onChange={(e) =>
                    setAdminData((prev) => ({ ...prev, bio: e.target.value }))
                  }
                  disabled={!isEditing}
              ...
              <div className="flex items-center justify-between">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    ...
                    checked={adminData.preferences.emailNotifications}
                    onChange={(e) =>
                      setAdminData((prev) => ({
                        ...prev,
                        preferences: {
              ...
              <div className="flex items-center justify-between">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
                    className="sr-only peer"
                    checked={adminData.preferences.pushNotifications}
                    onChange={(e) =>
                      setAdminData((prev) => ({
                        ...prev,
                        preferences: {
